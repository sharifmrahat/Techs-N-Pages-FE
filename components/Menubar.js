...
const userLink = [
  {
    ...
    name: "Dashboard",
    link: "/dashboard",
    icon: <ViewColumnsIcon className="w-5 h-5 mr-2"></ViewColumnsIcon>,
  },
  {
    id: 2,
    name: "My Bag",
    link: "/dashboard/bag",
    icon: <ShoppingBagIcon className="w-5 h-5 mr-2"></ShoppingBagIcon>,
  },
  {
    id: 4,
    name: "Profile",
    link: "/dashboard/profile",
    icon: <UserCircleIcon className="w-5 h-5 mr-2"></UserCircleIcon>,
  },
];
                        ...
                        {query && !books?.length ? (
                          <Combobox.Options
                            className={`${
                              !query
                                ? "hidden"
                                : "absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-300 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                            }`}
                          >
                          ...
                          <Menu.Item>
                            {({ active }) => (
                              <>
                                ...
                                <button
                                  className="flex justify-center items-center w-full px-4 py-2 text-sm hover:bg-red-700 hover:text-slate-100"
