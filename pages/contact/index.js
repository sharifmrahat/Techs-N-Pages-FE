      ...
      <div className="mx-auto max-w-7xl pt-10 px-4 pb-28">
        <div className="relative bg-white dark:bg-slate-800 shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            {/* Contact information */}
            <div className="relative overflow-hidden bg-indigo-700 dark:bg-indigo-500 py-10 px-6 sm:px-10 xl:p-12">
              ...
              <p className="mt-6 max-w-3xl text-base text-slate-100">
            ...
            <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
              ...
              <form action="#" method="POST" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      className="block w-full rounded-md  py-3 px-4 bg-slate-100 dark:bg-gray-700 shadow-sm focus:outline-none"
                    />
                  </div>
                </div>
                <div>
                ...
                <div className="sm:col-span-2 sm:flex sm:justify-end">
                  <button
                    type="submit"
                    className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 dark:bg-indigo-400 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 dark:hover:bg-indigo-500 focus:outline-none  sm:w-auto"
                  >
                    Send
                  </button>
                </div>
